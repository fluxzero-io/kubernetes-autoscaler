...
func (p *AutoprovisioningNodeGroupManager) CreateNodeGroup(context *ca_context.AutoscalingContext, nodeGroup cloudprovider.NodeGroup) (CreateNodeGroupResult, errors.AutoscalerError) {
...
func (p *AutoprovisioningNodeGroupManager) CreateNodeGroupAsync(context *ca_context.AutoscalingContext, nodeGroup cloudprovider.NodeGroup, nodeGroupInitializer AsyncNodeGroupInitializer) (CreateNodeGroupResult, errors.AutoscalerError) {
	return p.createNodeGroup(context, nodeGroup)
}
...
func (p *AutoprovisioningNodeGroupManager) RemoveUnneededNodeGroups(context *ca_context.AutoscalingContext) ([]cloudprovider.NodeGroup, error) {
